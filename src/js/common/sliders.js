export function initSliders() {
  ...
  const sliderACategories = new Swiper(".articles-categories__slider", {
    slidesPerView: "auto",
    // breakpoints: {
    //   320: {
    //     slidesPerView: 1.1,
    ...
    spaceBetween: 40,
    navigation: {
      nextEl: ".articles-categories .swiper-button-next",
      prevEl: ".articles-categories .swiper-button-prev",
    },
  });
}
